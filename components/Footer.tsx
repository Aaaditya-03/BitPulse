			...
			<div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
					...
					<div className="md:col-span-2 space-y-4">
						...
						<p className="text-sm text-purple-200/50 max-w-sm leading-relaxed">
							BitPulse is an interactive high-frequency cryptocurrency terminal
							and screener. Monitor price movements, track trending coins, and
							query safety insights powered by Gemini AI.
						</p>
					...
					<div className="space-y-4">
						...
						<div className="flex items-start gap-2 text-xs text-purple-200/50 leading-relaxed">
							...
							<span>
								Charts rendered using TradingView's lightweight-charts engine.
								Prices retrieved from CoinGecko API (Demo License).
							</span>
						</div>
						<div className="flex items-start gap-2 text-xs text-purple-200/50 leading-relaxed">
							<ShieldCheck className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />
							<span>
								Safety metrics are calculated algorithmically based on
								volatility and volume to identify trading risk.
							</span>
						</div>
					</div>
				</div>
				...
				<div className="border-t border-purple-500/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
					<p className="text-xs text-purple-200/40 text-center md:text-left leading-relaxed max-w-2xl">
						<strong>Disclaimer:</strong> Cryptocurrency assets are highly
						volatile and speculative. The safety index, chatbot analysis, and
						screener metrics on BitPulse are for educational and informational
						purposes only. They do not constitute financial or investment
						advice. Always perform your own diligence before trading.
					</p>
					<div className="text-xs text-purple-200/40 flex items-center gap-1 shrink-0">
						&copy; {new Date().getFullYear()} BitPulse. Built with{" "}
